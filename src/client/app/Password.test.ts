...
test('Testando a construcao de um classe Password pelo método `define` fornecido.', async () => {
...
test('Testando o uso de Array  externo para construção do token.', async () => {
